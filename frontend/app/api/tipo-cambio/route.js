...
export async function GET(req) {
  ...
  try {
    ...
    console.error("GET /api/tipo-cambio error:", e);
    return NextResponse.json({ 
      success: false,
...
export async function POST(req) {
  ...
  try {
    ...
    console.error("POST /api/tipo-cambio error:", e);
    return NextResponse.json({ 
      success: false,
...
export async function PATCH(req) {
  ...
  try {
    ...
    console.error("PATCH /api/tipo-cambio error:", e);
    return NextResponse.json({ 
...
export async function DELETE(req) {
  ...
  try {
    ...
    console.error("DELETE /api/tipo-cambio error:", e);
    return NextResponse.json({ 
