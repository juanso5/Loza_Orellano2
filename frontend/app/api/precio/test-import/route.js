...
/**
 * POST /api/precio/test-import
 * 
 * ⚠️ ENDPOINT DE PRUEBA SIN AUTENTICACIÓN
  ...
  try {
    ...
    return NextResponse.json({ 
      ...
      data: {
        ...
        errores: errorLines.length > 0 ? errorLines.slice(0, 10) : undefined,
    ...
    console.error('POST /api/precio/test-import error:', e);
    return NextResponse.json({ 
      success: false, 
      error: e.message 
    }, { status: 500 });
